...
public class TratamentoCategoria {
    ...
    public static void validar(Categoria categoria) throws DadosInvalidosException {
        ...
        else if(categoria.getNome() == null || categoria.getNome().isEmpty() || categoria.getNome().length() > 30){
